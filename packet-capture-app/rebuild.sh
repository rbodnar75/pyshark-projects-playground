...
sudo docker run -d --name mrpacketcapture --cap-add=NET_ADMIN -p 8000:8000 -v /home/rbodnar/pyshark-projects-playground/data:/app/src/data mrpacketcapture
#sudo docker run -d --name mrpacketcapture --cap-add=NET_ADMIN -p 8000:8000 -v /data:/app/src/data mrpacketcapture
